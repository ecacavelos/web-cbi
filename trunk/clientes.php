    ...
    <div id="wrap">
        <div id="content">
            ...
            <div id="main-section"><a class="transition b1" href="empresa.php"><img class="claro b1" src="images/boton-claro.png" width="196" height="143"/></a>
                ...
                <a class="transition b4" href="#"><img class="oscuro b4" src="images/boton-clientes.png" width="198" height="145"/></a>
                <a class="transition b5" href="contacto.php"><img class="claro b5" src="images/boton-claro.png" width="198" height="145"/></a>
            </div>
            <div id="text-area" class="client_list">
	            <div id="column1">
                ...
                <div id="column2">
	                <div class="client_list_item"><img src="images/clientes/RTEmagicC_G_Data_25Y-Logo_550x550_13.png"><div class="client_list_caption">Mutual</div></div>
